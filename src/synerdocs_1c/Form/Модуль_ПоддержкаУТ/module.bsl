...
Функция ДолжностьФизЛица(ФизЛицо, Организация, Дата) Экспорт
	...
	Сотрудник = ФормированиеПечатныхФорм.ДолжностьОтветственногоЛицаОрганизации(ФизЛицо, Дата, Организация);
...
Функция ВидТелефона(Ссылка) Экспорт
	...
	ВидыТелефонов[Тип("СправочникСсылка.ФизическиеЛица")]	= ВидыКИ.ТелефонФизЛицаСлужебный;
